...
import com.itech.e_commerce.CoursePage;
...
public class CourseAdapter extends RecyclerView.Adapter<CourseAdapter.CourseViewHolder> {
    ...
    public static final class CourseViewHolder extends RecyclerView.ViewHolder {
        ...
        public CourseViewHolder(@NonNull @NotNull View itemView) {
            super(itemView);
            this.courseBg = itemView.findViewById(R.id.courseBg);
            this.courseImage = itemView.findViewById(R.id.courseImage);
            this.courseTitle = itemView.findViewById(R.id.courseTitle);
            this.courseDate = itemView.findViewById(R.id.courseDate);
            this.courseLevel = itemView.findViewById(R.id.courseLevel);
        }
    }
}
